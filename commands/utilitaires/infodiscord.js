...
exports.run = (client, message, args) => {
    ...
    var infodiscord = new Discord.RichEmbed()
        ...
        .addField("<:membres:532634174738399252> • __Utilisateurs :__ ", `**${userSizenobot}** utilisateurs`, true)
        ...
        .addField("<:system:532634174859902996> • __Nombre de rôles__ :", `**${message.guild.roles.size}** rôles`, true)
        .addField("🔧 • __Nombre d'émojis :__", `**${message.guild.emojis.size}** émojis`, true)
        .addField("<:calendrier:532634174797119518> • __Date de création__ :", `${moment(message.channel.guild.createdAt).format("LL")}`, true)
        .setColor("#8697CB")
